...
namespace lending_skills_backend.Migrations
{
    ...
    [Migration("20250507180841_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lending_skills_backend.Models.DbBlock", b =>
                {
                    b.HasOne("lending_skills_backend.Models.DbForm", "Form")
                        .WithMany()
                        .HasForeignKey("FormId");

                    b.HasOne("lending_skills_backend.Models.DbBlock", "NextBlock")
                        .WithMany()
                        .HasForeignKey("NextBlockId");

                    b.HasOne("lending_skills_backend.Models.DbPage", "Page")
                        .WithMany("Blocks")
                        .HasForeignKey("PageId");

                    b.HasOne("lending_skills_backend.Models.DbBlock", "PreviousBlock")
                        .WithMany()
